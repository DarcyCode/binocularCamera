...
//	m_CBNResolution.SetCurSel(1);
	...
	CheckRadioButton(IDC_RAD_SGBM, IDC_RAD_BM, IDC_RAD_BM);								// 默认使用 BM 算法计算视差
	CheckRadioButton(IDC_RAD_DispFromImg, IDC_RAD_DispFromCam, IDC_RAD_DispFromCam);	// 默认从摄像机获取图像
